...
Výzkumné a datové repozitáře & Kaggle, UCI Machine Learning Repository, AWS Open Data &
benchmarkové datasety, prototypy modelů, výuka, opakovatelné experimenty \\
...
\begin{itemize}
  ...
  \item \term{EU-SILC, ESS a VŠIT} - příklady sekundárních šetření pro sociální, ekonomické a
  digitální chování domácností a jednotlivců; jsou užitečné, když potřebujeme standardizovanou
  metodiku a srovnání v čase nebo mezi zeměmi.
...
\subsection{OSINT}
\term{OSINT}, tedy open-source intelligence, znamená systematické získávání a vyhodnocování informací
z otevřených zdrojů. Nejde jen o otevřená data ve formálním smyslu. Patří sem webové stránky, registry,
média, sociální sítě, diskuse, akademické databáze, veřejné dokumenty, otevřené datové sady, mapy,
fotografie nebo metadata.

V datové analytice OSINT rozšiřuje interní data o kontext:
\begin{itemize}
  \item monitoring konkurence, cen, produktů a pracovních nabídek;
  \item sledování reputace, sentimentu a krizových signálů;
  \item obohacení firemních nebo regionálních dat z registrů a veřejných zdrojů;
  \item identifikace rizik, vazeb mezi subjekty nebo změn v regulaci.
\end{itemize}

OSINT musí být legální, reprodukovatelný a ověřený. U zkoušky je dobré zdůraznit, že \uv{veřejně
dostupné} neznamená automaticky \uv{volně použitelné}. Je nutné řešit licenci, podmínky služby,
ochranu osobních údajů, etiku, kvalitu zdroje a možnost ověřit informaci z více nezávislých zdrojů.

\subsection{Informační chování a Wilsonův model}
\term{Informační chování} popisuje, jak člověk rozpozná informační potřebu, hledá zdroje, vybírá mezi
nimi, hodnotí relevanci a informace používá při rozhodování. U externích zdrojů je to důležité proto,
že analytik neřeší jen technické stažení dat, ale i to, jakou otázku má zdroj zodpovědět, jaké bariéry
hledání existují a zda uživatel výstupu informaci skutečně využije.

\term{Wilsonův model} chápe hledání informací jako proces vyvolaný informační potřebou v určitém
kontextu. Na hledání působí osobní, sociální, organizační a environmentální faktory a také bariéry,
například čas, přístup ke zdrojům, informační gramotnost, jazyk nebo důvěra ve zdroj. Výsledkem může
být aktivní vyhledávání, pasivní sledování informací nebo vyhnutí se informaci.

Pro státnice stačí umět říct, že informační vyhledávání není pouze dotaz do databáze. Je to lidský
a organizační proces: uživatel musí mít potřebu, motivaci, vhodné zdroje, schopnost posoudit relevanci
a cestu, jak informaci převést do rozhodnutí.
...
\begin{itemize}
  ...
  \item \term{wrapper} - extrakční pravidla nebo programová vrstva, která z webu či dokumentu udělá
  strukturované záznamy, například ceník konkurence převede na tabulku produktů;
...
Při spojování externích a interních zdrojů je často potřeba \term{schema matching}, tedy mapování
polí se stejným významem, ale jiným názvem nebo granularitou. Například externí dataset může používat
\uv{company\_id}, interní systém IČO a CRM vlastní zákaznický identifikátor. Bez správného mapování
vznikají duplicity, chybné vazby a falešně přesné závěry.
...
\term{Business intelligence} a \term{competitive intelligence} se liší hlavním zdrojem a účelem.
BI typicky vychází z interních podnikových dat, vytváří datový sklad, reporty, dashboardy a KPI pro
řízení organizace. CI se dívá ven: na trh, konkurenci, zákazníky, regulaci, technologie a veřejné
informační zdroje. V praxi se doplňují, například interní pokles prodejů z BI se vysvětluje pomocí
externích signálů z CI.
