...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.72\linewidth]{assets/images/exploratorni-analyza/pca-gaussian-scatter.png}
  \caption[PCA a směry největší variability]{PCA hledá nové osy tak, aby první hlavní komponenta
  zachytila co největší rozptyl dat a další komponenty vysvětlovaly zbývající variabilitu v
  kolmých směrech. Popis obrázku: šedé body tvoří dvourozměrný mrak a šipky ukazují směry hlavních
  komponent. Zdroj obrázku: Ben FrantzDale,
  \href{https://commons.wikimedia.org/wiki/File:GaussianScatterPCA.png}{Wikimedia Commons},
  licence CC BY-SA 3.0 / GFDL.}
  \label{fig:pca-gaussian-scatter}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\linewidth]{assets/images/exploratorni-analyza/factor-analysis-loadings.png}
  \caption[Faktorové zátěže]{Faktorové zátěže ukazují, jak silně jsou pozorované proměnné spojeny
  s latentními faktory. Popis obrázku: šipky reprezentují proměnné a jejich souřadnice vůči dvěma
  faktorům; délka a směr šipky pomáhají interpretovat faktorovou strukturu. Zdroj obrázku:
  Chamaemelum, \href{https://commons.wikimedia.org/wiki/File:Factoranaly.png}{Wikimedia Commons},
  public domain chart.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.78\linewidth]{assets/images/exploratorni-analyza/correspondence-analysis-biplot.png}
  \caption[Korespondenční mapa]{Korespondenční mapa zobrazuje řádkové a sloupcové kategorie v
  nízkodimenzionálním prostoru podle jejich profilů. Popis obrázku: modré body/šipky ukazují
  řádkové kategorie a červené sloupcové kategorie; vzdálenost od středu signalizuje silnější
  příspěvek k asociaci. Zdroj obrázku: Sigbert,
  \href{https://commons.wikimedia.org/wiki/File:BiplotCA.svg}{Wikimedia Commons}, licence CC0 1.0.}
  \label{fig:correspondence-analysis-biplot}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.76\linewidth]{assets/images/exploratorni-analyza/lda-projection-static.png}
  \caption[LDA projekce]{Lineární diskriminační analýza hledá projekci, ve které jsou známé skupiny
  co nejlépe oddělené vzhledem k variabilitě uvnitř skupin. Popis obrázku: zelené a červené body
  jsou dvě skupiny a černá osa ukazuje směr projekce použitý pro diskriminaci. Zdroj obrázku:
  Amélia O. F. da S.,
  \href{https://commons.wikimedia.org/wiki/File:LDA\_Projection\_Illustration\_01.gif}{Wikimedia Commons},
  licence CC BY-SA 4.0; pro PDF použit statický snímek z animace.}
...
\pozor
U zkoušky je důležité rozlišit, co která metoda optimalizuje. PCA maximalizuje vysvětlenou variabilitu,
ne separaci skupin ani vztah k cílové proměnné. Faktorová analýza není jen \uv{jiný název pro PCA},
protože pracuje s latentními faktory a unikátní variabilitou. Korespondenční analýza se používá pro
kontingenční tabulky a vzdálenosti mezi řádkovými a sloupcovými body se nečtou stejně přímo jako
vzdálenosti uvnitř jednoho typu bodů. Diskriminační analýza je supervised metoda, a proto vyžaduje
známé skupiny a validaci klasifikační úspěšnosti.
...
\begin{itemize}
    ...
    \href{https://itl.nist.gov/div898/handbook/eda/eda.htm}{Exploratory Data Analysis}.
    \item scikit-learn User Guide:
    \href{https://scikit-learn.org/stable/modules/decomposition.html}{Decomposing signals in components}.
    \item scikit-learn User Guide:
    \href{https://scikit-learn.org/stable/modules/lda_qda.html}{Linear and Quadratic Discriminant Analysis}.
    \item R Documentation, FactoMineR:
    \href{https://search.r-project.org/CRAN/refmans/FactoMineR/html/CA.html}{Correspondence Analysis}.
    \item Wikimedia Commons:
    \href{https://commons.wikimedia.org/wiki/File:GaussianScatterPCA.png}{File:GaussianScatterPCA.png}.
    \item Wikimedia Commons:
    \href{https://commons.wikimedia.org/wiki/File:Factoranaly.png}{File:Factoranaly.png}.
    \item Wikimedia Commons:
    \href{https://commons.wikimedia.org/wiki/File:BiplotCA.svg}{File:BiplotCA.svg}.
    \item Wikimedia Commons:
    \href{https://commons.wikimedia.org/wiki/File:LDA\_Projection\_Illustration\_01.gif}{File:LDA\_Projection\_Illustration\_01.gif}.
\end{itemize}
