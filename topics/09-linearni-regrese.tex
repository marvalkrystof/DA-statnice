...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.82\linewidth]{assets/images/linearni-regrese/linear-regression-sums-of-squares.png}
  \caption[Rozklad variability v regresi]{Rozklad variability závisle proměnné v lineární regresi.
  Popis obrázku: tečkované úsečky ukazují rozdíl mezi skutečnými hodnotami, průměrem a regresní
  přímkou; nevysvětlená část vstupuje do reziduálního součtu čtverců a vysvětlená část do výpočtu
  koeficientu determinace. Zdroj obrázku: QuantuMechaniX8,
  \href{https://commons.wikimedia.org/wiki/File:Linear\_Regression\_Plot.png}{Wikimedia Commons},
  licence CC0 1.0.}
...
\term{Ridge} regrese používá \(L_2\) penalizaci a stabilizuje odhady při multikolinearitě. \term{LASSO}
používá \(L_1\) penalizaci a může některé koeficienty nastavit přesně na nulu, takže funguje i jako
výběr proměnných. \term{Elastic net} obě penalizace kombinuje.
